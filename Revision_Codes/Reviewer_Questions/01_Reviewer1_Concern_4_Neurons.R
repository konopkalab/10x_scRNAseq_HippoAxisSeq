...
openxlsx::write.xlsx(res_model, file = "Reviewer1/neurons_proportion_statistics.xlsx", colNames = TRUE, borders = "columns")

# Visualize the odds ratios vs -log10(FDR)
pdf("Reviewer1/AnteriorVsPosterior_NeuronsAbundance.pdf",width=5,height=5)
...
pdf("Reviewer1/AnteriorVsPosterior_NeuronsAbundance_Boxplot.pdf",width=8,height=8)
...
openxlsx::write.xlsx(prop, file = "Reviewer1/neurons_proportion_statistics_speckle.xlsx", colNames = TRUE, borders = "columns")
