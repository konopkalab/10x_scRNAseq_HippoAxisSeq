...
#metadata_pseudobulk_cell["Olig6"] <- NULL
#logcpm["Olig6"] <- NULL
...
openxlsx::write.xlsx(vars, file = "Reviewer2/Variance_Explained_Statistics.xlsx", colNames = TRUE, rowNames = TRUE,borders = "columns")

pdf("Reviewer2/Variance_Explained_Scater.pdf",width=6,height=6)
...
openxlsx::write.xlsx(as.data.frame(rowdat.sce), file = "Reviewer2/GenePropExpresInCell_Statistics.xlsx", colNames = TRUE, rowNames = TRUE,borders = "columns")
