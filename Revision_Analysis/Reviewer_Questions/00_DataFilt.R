...
load("input_data/HippoAxis.RData")
...
load("input_data/HippoAxis_Neurons.RData")
...
load("input_data/HippoAxis_InhibitoryNeurons.RData")


sce_inhibitory <- as.SingleCellExperiment(inh.renamed)

################### 
# Add information #
###################
temporary <- colData(sce_inhibitory) %>%
                                as.data.frame() %>%
                rownames_to_column("TMP") %>%
                select(-DF.classifications_0.25_0.01_3770,-DF.classifications_0.25_0.005_3794,-DF.classifications_0.25_0.005_2981,
                        -DF.classifications_0.25_0.01_1582,-pANN_0.25_0.01_3770,-pANN_0.25_0.005_2981,
...
colData(sce_inhibitory) <- temporary

#assays(sce_hippo) <- assays(sce_hippo)["logcounts"]

saveRDS(sce_inhibitory,"input_data/HippoAxis_InhbitoryNeurons_Filt.rds")
