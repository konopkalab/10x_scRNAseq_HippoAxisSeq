...
pdf("Reviewer1/MILO_Neurons_Results.pdf",width=12,height=8)
umap_pl + nh_graph_pl +
  plot_layout(guides="collect")
dev.off()

pdf("Reviewer1/MILO_Neurons_Results_Graph.pdf",width=8,height=8)
print(nh_graph_pl)
dev.off()

da_results <- annotateNhoods(sce_milo, da_results, coldata_col = "ident") 

openxlsx::write.xlsx(da_results, file = "Reviewer1/Cell_Milo_Neurons_Results.xlsx", colNames = TRUE, borders = "columns")

pdf("Reviewer1/MILO_Neurons_Results_Beeswarm.pdf",width=6,height=8)
