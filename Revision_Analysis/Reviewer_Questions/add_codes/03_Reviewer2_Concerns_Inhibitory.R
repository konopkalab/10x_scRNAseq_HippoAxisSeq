...
sce <- readRDS("input_data/HippoAxis_InhbitoryNeurons_Filt.rds")
...
cowplot::save_plot("Reviewer2/UMAPs_InhibitoryNeurons_Covariates.pdf", plot2by2, ncol = 2,base_height=6,base_width=4)


# 
pdf("Reviewer2/Heatmap_InhibitoryNeurons_CellPerAge.pdf",width=6,height=6)
...
pdf("Reviewer2/Heatmap_InhibitoryNeurons_CellPerSex.pdf",width=5,height=6)
...
pdf("Reviewer2/Variance_Explained_InhibitoryNeurons_Pseudobulk.pdf",width=5,height=4)
...
pdf("Reviewer2/Variance_Explained_InhibitoryNeurons_Pseudobulk_ByCell.pdf",width=6,height=6)
...
pdf("Reviewer2/Variance_Explained_InhibitoryNeurons_Pseudobulk_ByCell_boxplot.pdf",width=5,height=4)
...
pdf("Reviewer2/Fold_Change_InhibitoryNeurons.pdf",width=10,height=6)
...
openxlsx::write.xlsx(vars, file = "Reviewer2/Variance_Explained_Statistics_InhibitoryNeurons.xlsx", colNames = TRUE, rowNames = TRUE,borders = "columns")
